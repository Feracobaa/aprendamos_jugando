...
export default function CrearExamenPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto py-4 sm:py-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <Link href="/profesor/examenes" className="flex items-center gap-2 text-muted hover:text-foreground transition font-medium mb-8">
        <ArrowLeft size={18} />
        Volver a Exámenes
      </Link>
      ...
      <div className="bg-card rounded-3xl p-5 sm:p-8 border border-card-border shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-3">
             <Link href="/profesor/examenes" className="px-6 py-3 rounded-xl font-bold bg-badge-bg text-muted hover:bg-card-hover transition text-center">
               Cancelar
             </Link>
